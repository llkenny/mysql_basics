...
CREATE TABLE `employee` (
  ...
  `contract_id` int unsigned DEFAULT NULL COMMENT 'Контракт, к которому прикреплен сотрудник. Для упрощения, каждый сотрудник может быть прикреплен только к одному контракту.',
  `organization_id` int unsigned NOT NULL COMMENT 'Компания сотрудника',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_user_contract1_idx` (`contract_id`),
  KEY `fk_employee_organization1_idx` (`organization_id`),
  CONSTRAINT `fk_employee_organization1` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_user_contract1` FOREIGN KEY (`contract_id`) REFERENCES `contract` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Сотрудник компании';
...
INSERT INTO `employee` VALUES (1,'Иван Иванов',1,1),(2,'Иван Петр',1,1),(3,'Петр Иванов',1,1),(4,'Петр Петров',2,1),(5,'Василий Иванов',3,2),(6,'Александр Иванов',4,3),(7,'Владимир Иванов',6,4),(8,'Антон Иванов',7,4),(9,'Иван Антонов',7,4),(10,'Антон Антонов',7,4),(11,'Михаил Иванов',8,5),(12,'Михаил Петров',9,6),(13,'Евгений Иванов',9,6),(14,'Евгений Петров',10,6),(15,'Андрей Иванов',10,6),(16,'Андрей Петров',5,4);
